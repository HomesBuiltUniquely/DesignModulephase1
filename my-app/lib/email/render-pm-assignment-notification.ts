export function renderPmAssignmentNotificationEmail(params: {
  pmName: string;
  customerName: string;
  projectName?: string;
  projectId?: string;
  ...
  const subject = `You've Been Assigned – ${customerName} Project`;
        ...
        <table role="presentation" width="640" border="0" cellpadding="0" cellspacing="0" style="max-width:640px;background-color:#ffffff;border-radius:24px;overflow:hidden;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;box-shadow:0 10px 30px rgba(15,23,42,0.12);">
            ...
            <td style="padding:20px 28px 16px 28px;border-bottom:1px solid #e5e7eb;background:linear-gradient(90deg,#dbeafe,#e0e7ff);">
              <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                  ...
                  <div style="margin-top:4px;font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#1d4ed8;">Project Assignment</div>
                </div>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:22px 28px 10px 28px;">
              <p style="margin:0 0 10px 0;font-size:14px;color:#374151;">
                Dear <span style="font-weight:600;">${pmName}</span>,
              </p>
          ...
          <tr>
            <td style="padding:0 28px 18px 28px;">
              <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;overflow:hidden;">
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0 0 6px 0;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;color:#1e40af;font-weight:600;">Project Details</p>
          ...
          <tr>
            <td style="padding:12px 20px 16px 20px;background-color:#f9fafb;text-align:center;">
              <p style="margin:0;font-size:11px;color:#9ca3af;line-height:1.6;">Internal – Project Manager assignment notification.</p>
            </td>
          </tr>
        </table>
      </td>
