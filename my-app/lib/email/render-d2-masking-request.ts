export function renderD2MaskingRequestEmail(params: { customerName: string }) {
...
<head>
  ...
  <title>D2 – Masking Request</title>
</head>
          ...
          <tr>
            <td style="padding:22px 32px 8px 32px;">
              ...
              <p style="margin:0 0 10px 0;font-size:14px;line-height:1.6;color:#4b5563;">
                Hi ${customerName}, we&apos;re ready to proceed with site masking to protect your existing finishes before installation.
              </p>
            </td>
          </tr>
                ...
                <tr>
                  <td>
                    ...
                    <ul style="margin:0 0 8px 18px;padding:0;font-size:13px;line-height:1.6;color:#4b5563;">
                      <li>Areas to be masked will be confirmed by your project manager.</li>
                      <li>Masking includes floors, built‑ins and any sensitive surfaces in active zones.</li>
                      <li>Work will be coordinated to minimise disruption to your routine.</li>
                    </ul>
                    <p style="margin:8px 0 0 0;font-size:13px;line-height:1.6;color:#4b5563;">
                      Please confirm a suitable date and time so our team can schedule this visit.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color:#f9fafb;padding:16px 24px 18px 24px;text-align:center;">
              <p style="margin:0 0 4px 0;font-size:11px;letter-spacing:0.08em;text-transform:uppercase;color:#9ca3af;">
                You&apos;re receiving this as part of your installation preparation.
              </p>
