...
function ReceiptContent() {
  ...
  const numTotal = totalProjectValue
    ? Number(String(totalProjectValue).replace(/[^0-9.]/g, ""))
    : NaN;
  const numPaid = amountPaid
    ? Number(String(amountPaid).replace(/[^0-9.]/g, ""))
    : NaN;

  const displayTotalValue = !isNaN(numTotal)
    ? numTotal
    : numPaid
      ? numPaid * (type === "10p" ? 10 : 2.5)
      : 0;
  ...
  const displayReceiptNumber =
    transactionRef ||
    `HI-REC-2026-${projectId.replace(/[^0-9]/g, "") || "0387"}`;
  ...
  const milestoneName =
    type === "10p" ? "10_percent_milestone" : "40_percent_milestone";
  const pdfFileName = `${toFilenamePart(customerName)}_${milestoneName}_payment_receipt`;
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-8 print:bg-white print:p-0">
      ...
      <div className="w-full max-w-[640px] bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden print:shadow-none print:border-none print:max-w-full">
        ...
        <div className="px-8 pt-8 pb-4 flex justify-between items-center">
          <img
            src="https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/logo/LOGO+MAINPNG-01.png"
            width={100}
            height={100}
            alt="HUB Logo"
        ...
        <div className="px-8 pb-8">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            We have successfully received and confirmed your milestone payment.
            Your project is now cleared to proceed to the next phase.
          </p>
            ...
            <table className="w-full text-left border-collapse">
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="p-4 text-xs text-gray-500 uppercase font-semibold">
                    Receipt number
                  </td>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-4 text-sm text-gray-900 font-medium text-right">
                    {formatIndianCurrency(displayTotalValue)}
                  </td>
                </tr>
                <tr>
                  <td className="p-4 text-xs text-gray-500 uppercase font-semibold">
                  ...
                  <td className="p-4 text-sm text-[#E02424] font-bold text-right">
                    {formatIndianCurrency(displayBalanceRemaining)}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="border border-[#DEF7EC] bg-[#F3FBF7] rounded-xl px-5 py-3.5 mb-8">
            <div className="flex items-center gap-2 text-xs font-semibold text-[#03543F]">
              ...
              Confirmed ·{" "}
              {type === "10p"
                ? "Site masking phase begins within 24 hours"
                : "Production phase begins within 24 hours"}
            </div>
          </div>
