  ...
  <Section className="bg-brand-primary px-8 py-8 w-full rounded-b-xl border-t border-brand-primary">
    <Row>
      ...
      <Column align="center" className="w-[40%] align-center">
        <Img
          src={
            "https://hubinterior-quote-2026.s3.ap-south-2.amazonaws.com/logo/logo_transparent.png"
          }
          width="100"
          height="auto"
          alt="HUB Logo"
      ...
      <Column align="center" className="w-[60%] align-middle">
        ...
        <Text className="m-0 mt-2 text-white opacity-90 font-sans text-[12px] leading-[20px] font-semibold text-center">
          1st Floor, 6th Cross Rd, 1st Stage,
          <br />
          HBR Layout 4th Block,
          <br />
          Bengaluru, Karnataka 560044
        </Text>
        <Text className="m-0 mt-1 font-sans text-[12px] leading-[20px] font-semibold text-center">
          <Link
            href="mailto:hello@hubinterior.com"
            className="text-white opacity-90 underline"
          >
            hello@hubinterior.com | +91 07316914731
          </Link>
        </Text>
      </Column>
    </Row>
