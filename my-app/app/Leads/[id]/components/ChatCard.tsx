...
/**
 * ChatBox card in the lead detail grid.
 */
export default function ChatCard({ cardClass, onToggleMaximize, isMaximized }: Props) {
    return (
        <div className={cardClass}>
            <div className="flex justify-between items-start xl:justify-arround px-4">
                <h2 className="text-lg font-bold text-gray-900">ChatBox</h2>
                <button
