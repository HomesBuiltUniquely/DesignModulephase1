...
export default function PopupD1Measurement({ sessionId, onSubmit }: Props) {
  ...
  return (
    <>
      ...
      <div className="text-[12px] text-gray-400 px-6">
      ...
      <div className="flex items-center gap-2 px-7 py-7">
        <div>
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="size-5 text-gray-400 fill-gray-400"
          >
            <path
              strokeLinecap="round"
        ...
        <div className="font-bold text-[12px] text-gray-500 pl-1 tracking-wide">
          ASSIGNMENT
        </div>
      </div>
      <div>
        ...
        <div className="w-full max-w-[540px] border border-gray-300 rounded-md p-2 ml-6 mt-2 flex items-center justify-between min-h-[53px]">
          <div className="flex items-center gap-2 py-1.5 px-2 flex-1">
            ...
            {selected && (
              <span
                className="bg-green-500 rounded-full w-[8px] h-[8px] shrink-0"
                title="Selected"
              />
            )}
          </div>
        ...
        {loaded && executives.length === 0 && (
          <p className="text-xs text-amber-600 mt-1 px-6">
            No MMT executives in the system. Add them via MMT Manager → Register
            MMT Executive.
          </p>
        )}
        ...
        <div className="bg-gray-100 w-full h-[80px] rounded-b-2xl">
          ...
          <button className="mt-5 ml-98 bg-blue-500 rounded-md w-[150px] py-1.5 h-[36px] text-white text-sm font-bold text-center items-end">
            Submit Request
          </button>
          <button
            type="button"
            onClick={onSubmit}
            className="mt-5 ml-98 bg-blue-500 rounded-md w-[150px] py-1.5 h-[36px] text-white text-sm font-bold text-center items-end"
          >
            Submit Request
          </button>
        </div>
