  ...
  return (
    <div className="flex flex-1 flex-col min-h-0 relative">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        <div
          className={`flex flex-col border-r border-gray-200 min-w-0 bg-gray-50 transition-all ${dqc1PdfMaximized ? "flex-[1_1_100%] w-full" : "flex-1"}`}
        >
          <div className="px-4 py-2 text-xs text-gray-500">
            ERP Module &gt; Engineering &gt; Quality Control
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-white border-b border-gray-200 flex-wrap">
            <input
              ...
              className="hidden"
              onChange={onDqc1PdfSelected}
            />
            <span
              className="text-sm font-medium text-gray-700 truncate max-w-[240px]"
              title={dqc1PdfFile?.name ?? "No file selected"}
            >
              {dqc1PdfFile?.name ?? "Select a PDF"}
            </span>
            <button
              type="button"
              onClick={() => dqc1PdfInputRef.current?.click()}
            ...
            <span className="flex items-center gap-1 ml-auto">
              <span className="text-xs text-gray-500 flex items-center gap-1">
                <button
                  type="button"
                  onClick={() =>
                    setDqc1PdfPageNumber((p) => Math.max(1, p - 1))
                  }
                  className="p-0.5 rounded hover:bg-gray-200 disabled:opacity-50"
                  disabled={dqc1PdfPageNumber <= 1}
                ...
                <button
                  type="button"
                  onClick={() =>
                    setDqc1PdfPageNumber((p) =>
                      Math.min(dqc1PdfNumPages || 1, p + 1),
                    )
                  }
                  className="p-0.5 rounded hover:bg-gray-200 disabled:opacity-50"
                  disabled={dqc1PdfPageNumber >= (dqc1PdfNumPages || 1)}
            ...
            <button
              type="button"
              onClick={() => setDqc1PdfMaximized(!dqc1PdfMaximized)}
              className="p-1 rounded hover:bg-gray-100"
              aria-label={dqc1PdfMaximized ? "Exit fullscreen" : "Fullscreen"}
            >
              <svg
              ...
              >
                {dqc1PdfMaximized ? (
                  <path
                    ...
                    d="M9.75 3.75H4.5A.75.75 0 003.75 4.5v5.25M14.25 3.75H19.5a.75.75 0 01.75.75v5.25M3.75 14.25V19.5a.75.75 0 00.75.75h5.25M20.25 14.25V19.5a.75.75 0 01-.75.75h-5.25"
                  />
                ) : (
                  <path
                    strokeLinecap="round"
          ...
          <div
            ref={dqc1PdfScrollRef}
            className="flex-1 overflow-auto p-4 relative flex items-center justify-center min-h-80"
          >
            <div
              ref={dqc1PdfViewportRef}
              className="bg-white border border-gray-200 rounded-lg shadow-inner w-full max-w-4xl relative overflow-hidden"
            >
              {dqc1PdfUrl ? (
                <Dqc1PdfViewer
                  fileUrl={dqc1PdfUrl}
                  pageNumber={dqc1PdfPageNumber}
        ...
        <div
          className={`${dqc1PdfMaximized ? "hidden xl:flex xl:w-0" : "w-[420px]"} flex-shrink-0 flex flex-col overflow-hidden bg-white`}
        >
          ...
          <div className="p-4 flex-1 overflow-y-auto min-h-0">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Turn on Comment mode, go to the page (using &lt; &gt;), and
                ...
                {dqc1Remarks.map((r) => (
                  ...
                  >
                    <div className="flex justify-between items-start gap-2">
                      <span
                        className={`text-xs font-semibold ${r.priority === "high" ? "text-red-700" : r.priority === "medium" ? "text-amber-700" : "text-gray-600"}`}
                      >
                        {r.priority === "high"
                          ? "High Priority"
                          : r.priority === "medium"
                      ...
                      <span className="text-xs text-gray-500">
                        #{r.pinNumber} Pin {r.pinNumber}
                      </span>
                      <button
                        type="button"
                        onClick={(e) => {
                          e.stopPropagation();
                          removeDqc1Remark(r.id);
                        }}
              ...
              <div className="space-y-2">
                ...
                >
                  <input
                    type="radio"
                    name="dqc1Verdict"
                    checked={dqc1Verdict === "approved"}
                    onChange={() => setDqc1Verdict("approved")}
                    className="mt-1"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Design meets all quality standards.
                    </p>
                  </div>
                </label>
                <label
                ...
                >
                  <input
                    type="radio"
                    name="dqc1Verdict"
                    checked={dqc1Verdict === "rejected"}
                    onChange={() => setDqc1Verdict("rejected")}
                    className="mt-1"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Major flaws detected. Redesign needed.
                    </p>
                  </div>
                </label>
              </div>
      ...
      {dqc1CommentPopup && (
        <div
          ...
          onClick={() => setDqc1CommentPopup(null)}
        >
          <div
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-3">
              Comment will be pinned at the selected location on the PDF.
            </p>
            ...
            <textarea
              ...
              placeholder="Enter your QC remark..."
              className="w-full text-sm border border-gray-300 rounded-lg p-3 min-h-[100px] resize-y mb-4"
            />
