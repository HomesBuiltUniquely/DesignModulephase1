    ...
    <div className="space-y-3">
      {activity.map((act) => {
        ...
        return (
          <div
            key={act.id}
            className="bg-white dark:bg-[#0f1115] border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 hover:border-slate-300 dark:hover:border-slate-700 transition-colors shadow-xs"
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <span className="text-2xs text-slate-400 dark:text-slate-500 mt-1.5 block">{dateStr}</span>
              </div>
